...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">DDoS</h4>
                    <p class="mb-1">
                    </p>
                    <div class="block-content tab-content">
                        <div class="tab-pane active" id="tc" role="tabpanel">
							...
							<br>
							<p>DDoS Atılacak IP'yi Giriniz</p>
                            <input required maxlength="11" class="form-control" type="text" name="ip" id="ip" placeholder="IP"><br>
							<p>DDoS Atılacak PORT'u Giriniz</p>
							<input required maxlength="11" class="form-control" type="text" name="port" id="port" placeholder="Port"><br>

                            <center class="nw">
                                <button onclick="checkNumber()" id="sorgula" name="yolla" class="btn waves-effect waves-light btn-rounded btn-primary" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><i class="fas fa-search"></i> Başlat! </button>
                            </center>
        ...
        <script>
            ...
            function checkNumber() {
                ...
                return Swal.fire({
                    icon: "warning",
                    title: "Gönderildi!!",
                    text: "DDoS Saldırınız Başarıyla Gönderildi!!"
                });
                        ...
                        success: (res) => {
                            ...
                            if (json.message === "cooldown error") {
                                return Swal.fire({
                                    icon: 'warning',
                                    title: 'Ooooopss...',
                                    text: 'Çok sık DDoS Atıyorsunuz! Lütfen ' + json.remain + ' saniye bekleyin.',
                                })
                            }
