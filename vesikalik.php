...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Kimlik Fotoğrafı Sorgu</h4>
                    <p class="mb-1">
                    ...
                    <div class="block-content tab-content">
                        <div class="tab-pane active" role="tabpanel">
							...
							<div class="bg-dark rounded h-100 mt-2 p-4">
								<div class="d-flex justify-content-center" id="IMG">
									<img id="ornek" src="https://via.placeholder.com/150x200.png?text=Örnek+Resim" style="width: 150px; height: 200px;">
								</div>
							</div>
                ...
                success: (res) => {
                    ...
                    if (json.status === "true") {
                        ...
                        for (var i = 0; i < json.number; i++) {
							...
							var image = new Image();
							image.src = "data:image/png;base64," + vesika;
							image.id = "resultIMG";
							if (document.contains(document.getElementById('ornek'))) {
       					    	document.getElementById('ornek').remove();
							} else {
  					 	    	document.getElementById("IMG").appendChild(image); 
							}
							
							if (document.contains(document.getElementById('resultIMG'))) {
