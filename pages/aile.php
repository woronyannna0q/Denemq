...
<?php require_once '../pages/TOP_2.php'; ?>
   				...
   				<div class="container-fluid">
				         <div class="py-3">
                            <h4 class="m-0 font-weight-bold">Aile Sorgu</h4><br>
   ...
   <script>
        function clearResults() {
            $("#datatable").html(' <tr class="odd"><td valign="top" colspan="11" class="dataTables_empty">No data available in table</td></tr>');
        }
